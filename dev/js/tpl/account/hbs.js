define(["runtime","helpers"],function(Handlebars,helpers){

this["myApp"] = this["myApp"] || {};
this["myApp"]["account"] = this["myApp"]["account"] || {};
this["myApp"]["account"]["main"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
...
Handlebars.registerPartial("account/_account", this["myApp"]["account"]["_account"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "<h2>"
